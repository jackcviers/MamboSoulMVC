...
namespace BusinessObjects.GeneratedTables
{
    ...
    /// <summary>
    /// Description : 
    /// Table Created : 5/25/2015 4:09:22 PM
    /// </summary>
    public partial class BlogCategory : AbstractTable
    {
        private BlogCategoryData m_Current = new BlogCategoryData();
        private BlogCategoryData m_Original;
        
        public const string TABLE_NAME = "blog_category";
        ...
        /// provided data class.
        /// </summary>		
        public BlogCategory(SqlHelper db, BlogCategoryData data)
            : this(db, data.Id)
        {
        ...
        /// </summary>
        public BlogCategoryPrimaryKey PrimaryKey
        {
            get
            {
                BlogCategoryPrimaryKey key = new BlogCategoryPrimaryKey();
        ...
        protected override string GenerateSqlSelect(int context)
        {
            ...
            sql.Append("SELECT * FROM blog_category WITH (NOLOCK) ");
        ...
        protected override string GenerateSqlInsert(int context)
        {
            ...
            result.Append("INSERT INTO blog_category (");
        ...
        protected override string GenerateSqlUpdate(int context)
        {
            ...
            sql.Append("UPDATE blog_category SET ");
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("DELETE FROM blog_category");
            sql.Append(GenerateWhereClausePrimaryKey(context));
        ...
        /// </summary>
        public BlogCategoryData GetCurrentValues()
        {
        	
            return (BlogCategoryData)m_Current.Clone();
        }

        /// <summary>
        /// Sets the properties of the object from an instance of the data class.
        /// </summary>
        public void SetCurrentValues(BlogCategoryData data)
        {
            // set all fields
            Id = data.Id;
            Name = data.Name;
        ...
        /// </summary>
        public BlogCategoryData GetOriginalValues()
        {
            object result = null;
            if (m_Original != null) result = m_Original.Clone();
            return (BlogCategoryData)result;
        }
        ...
        {
            m_Original = (BlogCategoryData)m_Current.Clone();
        }
    ...
    #region List Class
    /// <summary>
    /// Manages a list of BlogCategory objects
    /// </summary>
    public partial class BlogCategoryList : AbstractTableList
    {
        #region Private Fields
        // Data structure to hold objects
        private List<BlogCategory> m_Items = new List<BlogCategory>();
        
        // Comparison<T> delegate for sorting purposes
        Comparison<BlogCategory> m_Comparison = null;
        #endregion
        ...
        /// </summary>
        public BlogCategoryList (SqlHelper db) : base(db) {}
        #endregion
        ...
        /// </summary>
        public IList<BlogCategory> Items
        {
            get
            {
                return m_Items;
        ...
        public override IList<AbstractTable> TableItems
        {
            get
            {
                ...
                BlogCategory[] list = new BlogCategory[m_Items.Count];
        ...
        /// </summary>
        public void Add(BlogCategory item)
        {
            m_Items.Add(item);
        ...
        public void Populate(string sql, SqlParameter[] commandParameters)
        {
            ...
            using (SqlDataReader dr = m_db.ExecuteReader(System.Data.CommandType.Text, sql, commandParameters))
            {
                while (dr.Read())
                {
                    BlogCategory item = new BlogCategory(m_db, dr);
                    this.Add(item);
                }
            }
        ...
        /// </summary>
        public void Sort(Comparison<BlogCategory> comparison)
        {
        ...
        /// </summary>
        public BlogCategory Find(int id)
        {
            BlogCategory result = null;
            BlogCategoryPrimaryKey key = new BlogCategoryPrimaryKey();
			key.Id = id;

            
            // Loop through our list until we find the match
            foreach (BlogCategory item in m_Items)
            {
        ...
        /// </summary>
        public bool Remove(BlogCategory item)
        {
        ...
        public BlogCategoryData[] GetCurrentValues()
        {
            List<BlogCategoryData> results = new List<BlogCategoryData>();
            foreach (BlogCategory item in m_Items)
            {
    ...
    #region Primary Key
    /// <summary>
    /// Class used to represent the primary key fields in the blog_category table
    /// </summary>
    public class BlogCategoryPrimaryKey : IComparable<BlogCategoryPrimaryKey> 
    {
		///<summary></summary>
		public int Id;
        ...
        ///<summary></summary>
        public int CompareTo(BlogCategoryPrimaryKey other)
        {
            int result = 0;
            if (other != null)
            {
    ...
    /// <summary>
    /// Manages a Sorted list of BlogCategory objects
    /// </summary>
    public partial class BlogCategorySortedList : AbstractTableList
    {
        private SortedList<BlogCategoryPrimaryKey, BlogCategory> m_Items = new SortedList<BlogCategoryPrimaryKey, BlogCategory>();

        /// <summary>
        /// Creates an instance of the list class and leaves the list empty
        /// </summary>
        public BlogCategorySortedList (SqlHelper db) : base(db) {}
        ...
        {
            List<BlogCategoryData> results = new List<BlogCategoryData>();
            foreach (BlogCategory item in m_Items.Values)
            {
                results.Add(item.GetCurrentValues());
            }
            return results.ToArray();
    ...
    #region Data Class
    /// <summary>
    /// Represents just the data in the blog_category table.
    /// </summary>
    public partial class BlogCategoryData : ICloneable
    {
		///<summary></summary>
		public int? Id ; 
		///<summary></summary>
